...
users_hits={} #dictionary for users hits
users_bytes={} #dictionary for users hits
    ...
    for line in fh:
        ...
        try:
            ...
            if path.startswith("/~"):
                ...
                try:
                    users_hits[user] = users_hits[user] + 1
                except:
                    users_hits[user] = 1

                try:
                    users_bytes[user] = users_bytes[user] + content_length
                except:
                    users_bytes[user] = 1
